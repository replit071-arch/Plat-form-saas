...
const {UserManagement,CouponManagement,BrandingSettings,Tickets,PayoutManagement} = () => {
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">{UserManagement,CouponManagement,BrandingSettings,Tickets,PayoutManagement}</h1>
...
export default {UserManagement,CouponManagement,BrandingSettings,Tickets,PayoutManagement};
